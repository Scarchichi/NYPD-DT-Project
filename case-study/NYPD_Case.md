...
1. Commissioner Kelly's successors inherited a surveillance platform built on more than $350 million in federal DHS grants, with documented operational successes—including linking suspects across thousands of license plate reads and live camera feeds—but a formal governance policy that arrived nearly a decade after citywide deployment began. Of the three strategic paths available (deeper operational integration across all precincts, restriction to counterterrorism and serious felony investigations, or genuine independent review with audit and enforcement authority), which would you recommend? What specific tradeoffs between investigative effectiveness, community trust, and long-term institutional legitimacy does your choice entail, and what do you sacrifice by not choosing each of the other two?

2. The 2021 DAS Impact and Use Policy established a civilian oversight board and data retention limits, but the ACLU's public response was unambiguous: "Who watches the watchers?" Genuine independent oversight—with authority to audit query logs, investigate complaints, and enforce restrictions—would require external parties to access sensitive intelligence operations that the NYPD considers operationally confidential. Is that form of oversight structurally compatible with running a real-time counterterrorism platform, or do the speed and secrecy requirements of intelligence work make meaningful external accountability impossible? If full oversight is not achievable, what is the minimum accountability structure that is both credible and operationally realistic?

3. Patternizr was trained on historical NYPD arrest and investigation records generated during a period of documented racially disproportionate stop-and-frisk enforcement—a program later ruled unconstitutional. If the training data reflects those enforcement patterns, the model may systematically direct future investigative attention toward the same communities that were over-policed in the past, reinforcing rather than correcting existing disparities. Defenders counter that the model identifies objective statistical patterns in crime occurrence, independent of race. Who bears the burden of proof in this debate, and what standard of evidence should be required before deploying a predictive analytics tool in routine investigations? How should a digital transformation leader weigh the tool's capacity to solve crimes faster against the risk of institutionalizing historical enforcement bias at scale?

4. The $350 million in federal DHS investment enabled DAS to scale from a Lower Manhattan pilot to a citywide platform spanning more than 9,000 cameras, 500 license plate readers, and integrated chemical and radiation sensors. Nearly a decade after launch, the first formal governance policy arrived without an independent audit mechanism, and civil liberties organizations had documented unresolved concerns about data retention periods, racial filtering in camera search interfaces, and the system's migration from counterterrorism to routine patrol use. Was the federal investment justified given what we now know about the governance gap? What oversight conditions—if any—should DHS have imposed as prerequisites for funding, and how would those conditions have changed the system that emerged?

5. By the mid-2010s, DAS surveillance infrastructure was most intensively concentrated in neighborhoods like East New York, Central Brooklyn, and the South Bronx—communities with the highest existing rates of police contact and some of the most fraught histories with law enforcement in the city. A digital transformation leader in a democratic public institution has legal authority, operational justification, and technical capacity to deploy such a system. But what, if anything, does that leader specifically owe to communities that are most directly and disproportionately affected by the technology, did not choose to be surveilled, and cannot opt out? How should that obligation—whatever its content—have shaped the design priorities, deployment sequence, data retention rules, and public engagement process for DAS?

6. Throughout the 2010s, the NYPD publicly framed DAS primarily as a counterterrorism response to the post-9/11 threat environment, using that justification to secure federal funding and public acceptance. By the mid-2010s, however, the system was being used for burglary investigations, misdemeanor tracking, and—as the Times Square protest incident revealed—monitoring the movements of civil rights organizers exercising their First Amendment rights. Does the DAS case suggest that the counterterrorism framing was used strategically to build a general-purpose surveillance capability under a more acceptable rationale? If so, what does that pattern imply for how city councils, federal funding agencies, and community oversight bodies should evaluate law enforcement technology requests—and what institutional safeguards might have caught this drift before it became entrenched?